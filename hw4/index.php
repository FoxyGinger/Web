...
$jobs = [
    [
        ...
        'desc' => 'Много интересных задач',
    ],
    [
        'name' => 'DINS',
        'data' => '2021 - 2022',
        'desc' => 'Различные значимые проекты',
    ],
    [
        'name' => 'Playrix',
        'data' => '2019 - 2021',
      ...
      <div class="w3-twothird">
        ...
        <?php for($i = 0; $i < count($jobs); $i++):?>
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $jobs[$i]['data']?></h6>
